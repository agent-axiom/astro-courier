...
The game also supports gamepad input and a large touch steering pad on mobile browsers. On phones, the preflight screen stays focused on the art, key choices, Cloud/Restore, and `Launch`.
